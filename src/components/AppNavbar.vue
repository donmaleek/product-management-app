 ...
 * @description Main navigation sidebar with mobile responsiveness
 * @version 1.0
-->
    ...
    >
      ...
      <nav class="flex-1 px-4 space-y-2 mt-4 overflow-y-auto">
        ...
        <router-link 
          ...
          :class="$route.name === 'Dashboard' ? 'bg-indigo-50 text-[#172A5A]' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50'"
        >
        ...
        <router-link 
          ...
          :class="$route.name === 'ProductList' ? 'bg-indigo-50 text-[#172A5A]' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50'"
        >
          <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <router-link 
          ...
          @click="closeSidebar" 
          class="flex items-center px-4 py-3 text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors group"
          :class="$route.name === 'Orders' ? 'bg-indigo-50 text-[#172A5A]' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50'"
        >
          <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <router-link 
          ...
          @click="closeSidebar" 
          class="flex items-center px-4 py-3 text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors group"
          :class="$route.name === 'Customers' ? 'bg-indigo-50 text-[#172A5A]' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50'"
        >
          <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="p-4 mb-4 space-y-4">
        ...
        <router-link 
          ...
          :class="$route.name === 'Settings' ? 'bg-indigo-50 text-[#172A5A]' : 'text-gray-500 hover:text-gray-900'"
        >
          <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
/**
 * Closes sidebar when navigation items are clicked on mobile
 */
const closeSidebar = () => {
